...
Passed!  - Failed:     0, Passed:     4, Skipped:     5, Total:     9, Duration: 248 ms - DataProcessor.Library.Tests.dll (net7.0)
```
...
Passed!  - Failed:     0, Passed:     9, Skipped:     0, Total:     9, Duration: 85 ms - DataProcessor.Library.Tests.dll (net7.0)
```
